...
from stockrating.stock_block_tdx import  get_tdx_custom_block_from_date,get_tdx_custom_block_from_name
from stockrating.stock_rating_history import  calculate_symbol_score
from dataanalysis.cal_excel_per import  calculate_positive_percentage
from dataanalysis.cal_stocks_tech import process_single_stock
import json
import logging
...
def process_file_stock_data(file_path, output_file):
    analyze_custom_date_code_data(file_path)
