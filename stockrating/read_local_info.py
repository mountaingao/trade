...
def get_stock_market_value(query):
...
def read_stock_market_value_from_db(code=None):
    import pandas as pd
    from sqlalchemy import create_engine
    ...
    result_df.rename(columns={'index': 'code', market_value_column: '流股市值'}, inplace=True)
    result_df.rename(columns={'index': 'code', '股票简称': 'name'}, inplace=True)
    
    return result_df

# 示例调用
result_data = read_stock_market_value_from_db(code='300263')
print(result_data)


print(result_data[result_data['code'] == '300264'])
